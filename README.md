# ![Flux Capacitor](flux-capacitor-icon/flux_icon_100.png) Flux [![Build Status](https://travis-ci.org/whiskeysierra/flux.png?branch=master)](http://travis-ci.org/whiskeysierra/flux)
